...
<body>
    <div class="container">
        <div class="row">
            <div class="col">
                <img class="logo" src="logo.png" alt=""><h5>Privacy e Termini</h5>
            </div>
        </div>
        <div class="row">
            <div class="col-6 d-flex justify-content-between padding">
                <h6>Introduzione</h6>
                <h6>Norme sulla privacy</h6>
                <h6>Termini di servizio</h6>
                <h6>Tecnologie</h6>
        ...
        <hr>
        <div class="row">
            <div class="col-10 offset-1 padding">
                    <?php
                        $faqs= [
                            [
                        ...
                        foreach($faqs as $faq) {
                            echo "<h3>{$faq["question"]}</h3> <br> {$faq["answer"]} <br> <hr>";
                        }
                    ?>
            </div>
        </div>
